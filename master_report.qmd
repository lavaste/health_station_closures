...
checkboxInput(
  inputId = "show_other_stations",
  label = "Show other stations",
  value = TRUE
)

checkboxInput(
  inputId = "show_new_stations",
  label = "Show new clinics",
  value = TRUE
)

checkboxInput(
  inputId = "show_closed_stations",
  label = "Show closed clinics",
  value = TRUE
)
```
...
#    show_fill = isTRUE(input$show_fill),
#    show_other_stations = isTRUE(input$show_other_stations),
#    show_new_stations = isTRUE(input$show_new_stations),
#    show_closed_stations = isTRUE(input$show_closed_stations)
#  )
# })

source(here::here("scripts", "interactive_map.R"))
interactive_plot
